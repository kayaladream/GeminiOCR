  ...
  return (
    <div className="app">
      <header>
        ...
        <h1>高精度OCR识别</h1>
        <p>智能识别多国语言，识别出的表格是 Markdown 格式，请到 <a href="https://tableconvert.com/zh-cn/markdown-to-markdown" target="_blank">https://tableconvert.com/zh-cn/markdown-to-markdown</a> 在线转换</p>
      </header>
